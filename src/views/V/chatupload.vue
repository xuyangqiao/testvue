    ...
    <div class="chart-wrpaper clearfix">
        <div class="chart-left">
            <div class="box-flex-media-box">
                ...
                <el-button type="sure" @click="toDetail('V_detail')">{{$lang('查看任务')}}&gt;</el-button>
            </div>
        ...
        <el-dialog :title="$lang('上传文件')" ref="toSubmitUpload" :visible.sync="toSubmitUploadShow" size="tiny" :before-close="toSubmitUploadClose" v-loading.body="loading">
            <el-form>
                ...
                <el-form-item :label="$lang('资源文件：')">
                    <el-upload class="upload-demo" action="https://jsonplaceholder.typicode.com/posts/" ref="indexFile" :file-list="IndexFileList" :on-change="IndexFileChange" :on-remove="IndexFileRemove" :autoUpload="false">
