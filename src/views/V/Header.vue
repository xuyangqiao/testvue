    ...
    <div class="new-header">
            ...
            <div class="header-top-main">
                <div class="fr">
                    <div class="htm-jh box-flex-media-box">
                        ...
                        <a href="javascript:;" class="nh-a-02" @click="onNavigation('V-userInfo-base','userInfo')">个人中心</a>
        ...
        <div class="header-content box-flex-media-box">
            ...
            <ul class="nav-ul-jh box-flex-media-box">
                <li class="nav-li-jh">
                    <a href="javascript:;" :class="navIndx=='index'&&'active'" @click="onNavigation('V_Index','index')">大厅</a>
                </li>
                <li class="nav-li-jh">
                    <a href="javascript:;" :class="navIndx=='list'&&'active'" @click="onNavigation('V_TaskList','list')">制作中心</a>
                </li>
                <li class="nav-li-jh">
                    <a href="javascript:;" @click="$router.push({name:'V_Notices'})">通知中心</a>
                </li>
            </ul>
        </div>
    </div>
