  ...
  <TInfo :onload="load">
    <div slot="footer" class="bt-dashed">
      <div class="set-btn-wrap" v-show="visible">
        <el-button type="sure" @click="onPass">通过</el-button>
        <el-button type="danger" @click="visible=false">驳回</el-button>
      </div>
      <div class="reject-wrap" v-show="!visible">
        <el-input type="textarea" :rows="5" placeholder="请输入内容" v-model="remark"></el-input>
        <div class="set-btn-right">
          <el-button type="sure" @click="onReject">提交</el-button>
          <el-button type="danger" @click="visible=true">取消</el-button>
        </div>
      </div>
    </div>
  </TInfo>
