<template>
  ...
  <div class="content-wrapper">
    <div class="all-task-wrapper">
      <Ts-Info title="任务详情" :isZong="false" role="S"></Ts-Info>
      ...
      <div class="all-task-other">
        <template>
          <el-table :data="list" stripe style="width: 100%">
            ...
            <el-table-column property="nickName" label="企业" width="480">
            </el-table-column>
            <el-table-column property="createTime" label="日期" width="280">
            </el-table-column>
            <el-table-column prop="state" label="类型" width="" >
