      ...
      <div class="all-task-other">
        <template>
          <el-table :data="list" stripe style="width: 100%">
            ...
            <el-table-column property="nickName" :label="$lang('用户名')">
            </el-table-column>
            <el-table-column property="createTime" :label="$lang('日期')">
            </el-table-column>
            <el-table-column prop="state" :label="$lang('类型')">
            ...
            <el-table-column prop="remarkName" :label="$lang('备注')"></el-table-column>
          </el-table>
        </template>
