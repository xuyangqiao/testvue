                    ...
                    <el-row>
                        <el-row>
                            <el-col :span="12">
                                ...
                                <el-form-item :label="$lang('应用类别:')" required>
                                ...
                                <el-form-item :label="$lang('贴图大小:')" required>
                                ...
                                <el-form-item :label="$lang('模型格式:')" required>
                                ...
                                <el-form-item :label="$lang('贴图格式:')" required>
                                ...
                                <el-form-item :label="$lang('模型精度:')" required>
                                ...
                                <el-form-item :label="$lang('场景制作单位:')" required>
                        ...
                        <div class="jdx-add-task">
                            ...
                            <el-row v-for="(item,i) in form.taskStages" :key="i">
                                <el-col :span="12">
                                    <el-form-item :label="$lang('阶段名称:')" required>
                                ...
                                <el-col :span="22">
                                    <el-form-item :label="$lang('阶段说明:')" required>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        projectName: [
          { required: true, message: $lang("请输入活动名称"), trigger: "blur" }
        ],
        total: [
          { required: true, message: $lang("请输入意向出价"), trigger: "change" }
        ],
        taskEndTime: [
          {
            required: true,
            message: $lang("请输入任务结束时间"),
            trigger: "change",
            type: "date"
          }
        ],
        entryEndTime: [
          {
            required: true,
            message: $lang("请输入报名结束时间"),
            trigger: "change",
            type: "date"
          }
        ],
        appType: [
          { required: true, message: $lang("请输入应用类别"), trigger: "change" }
        ],
        appAreas: [
          { required: true, message: $lang("请输入应用领域"), trigger: "change" }
        ],
        vevironments: [
          { required: true, message: $lang("请输入应用环境"), trigger: "change" }
        ],
        chartlatFormat: [
          { required: true, message: $lang("请输入模型风格"), trigger: "change" }
        ],
        chartlatSize: [
          { required: true, message: $lang("请输入贴图大小"), trigger: "change" }
        ],
        modelStyle: [
          {
            required: true,
            message: $lang("请输入模型格式"),
            trigger: "change",
            type: "array"
          }
        ]
  ...
  methods: {
    ...
    uploadAllFile(id) {
      ...
      file.map((item, i) => {
        if (fileListType[i] == 3) {
          PromiseList.push(
            uploadFile(item, `/task/${id}`, "childTaskCreateDiv" + j++)
          );
        } else {
