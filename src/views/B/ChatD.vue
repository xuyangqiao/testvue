    ...
    <div class="chart-wrpaper clearfix">
        <div class="chart-left">
            <div class="box-flex-media-box">
                ...
                <el-button type="sure" @click="$router.push({name:'B_TaskChildDetail',query: { id: $route.query.id }})">查看任务&gt;</el-button>
            </div>
                ...
                <ul class="chart-left-ul">
                    <li class="chart-left-li" v-for="(item,i) in taskStage" :key="i">
                        <div class="box-flex-media-box cl-top">
                            ...
                            <!--<el-button size="small"  type="info" style="z-index: 1" >查看聊天记录</el-button>-->
                            <el-button size="small" type="info" @click="$router.push({name:'B_History',query: { id: item.id, index: i }})">查看历史</el-button>
                        </div>
                    ...
                    <li class="chart-left-li">
                        <div class="box-flex-media-box cl-top">
                            ...
                            <a href="javascript:;" class="title flex1">
                                <h4>验收</h4>
                                <p>截止时间：{{subTask.taskEndTime}}</p>
                            </a>
                            <el-button size="small" type="info" @click="$router.push({name:'B_DTaskCheck',query: { id: subTask.id }})">预览</el-button>
                            <el-button size="small" type="info" @click="$router.push({name:'B_History',query: { id: subTask.id, index: -1 }})">查看历史</el-button>
                        </div>
                        <dl class="box-flex cl-info">
                            <dt>阶段详情：</dt>
