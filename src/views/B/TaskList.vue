    ...
    data() {
        return {
            ...
            childTasks: [
                ...
                { name: $lang("制作中"), value: 5, count: 99, color: "zzz", to: "B_ChatT" },
                { name: $lang("验收中"), value: 6, count: 99, color: "ysz", to: "B_ChatT" },
                { name: $lang("已完成"), value: [7, 8], count: 99, color: "wc", to: "B_ChatT" },
