<template>
    <div class="content-wrapper">
        <div class="all-task-wrapper">
            <TsInfo :onload="onloadCallBack" :title="title" :isZong="isZong" :role="role" :name="stateName" :userType="userType">
            </TsInfo>
        ...
        <el-dialog
            ...
            <div class="dialog-img-preview">
                <div class="dialog-img-preview-left"><i @click="imgPreviewArrow(-1)" class="el-icon-arrow-left"></i></div>
                <img :src="dialogImageUrl" alt="">
                <div class="dialog-img-preview-right"><i @click="imgPreviewArrow(1)" class="el-icon-arrow-right"></i></div>
            </div>
        </el-dialog>
    </div>
</template>
