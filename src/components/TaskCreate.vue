...
import { TaskInfoById, SaveTaskGroup, TaskAdd, TaskSave, getTackParam, saveGroup, removeGroup } from '@/apis/task'
...
export default {
    ...
    methods: {
        ...
        async createGroupConfirm() {
            ...
            this.taskGroup.push(Object.assign(data.data, { editable: false, backup: data.data.groupName }));
