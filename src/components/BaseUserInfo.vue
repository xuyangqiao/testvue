    ...
    <div class="base-user-info">
        ...
        <div class="add-sun-cont" v-if="edit" v-loading="loading">
            <div class="base-info-edit">
                ...
                <el-form ref="form" :model="form1" label-width="20" :rules="rules">
                    <el-form-item label=" " required>
                        <el-input v-model="form1.nickName" :placeholder="$lang('请输入姓名')"></el-input>
                    </el-form-item>
                    <VerifyCode label-width="20"  :phone="form1.contact" :code="form1.code" :parentClass="'add-sun-cont'" :type="'baseInfo'" :getData="getData"></VerifyCode>
                    <el-form-item label=" " required>
...
<style>
.base-user-info .el-form-item__content {
  width: 350px;
